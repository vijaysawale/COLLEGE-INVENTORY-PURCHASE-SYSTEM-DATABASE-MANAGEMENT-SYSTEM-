...
<head>
    ...
    <title>Ongoing Purchase Order</title>
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">Ongoing Purchase Orders</span></h2>
                                <style>
                                    #Welcome
                                    {
                        ...
                        <table id="dtBasicExample" class="table table-striped table-bordered table-sm sortable" cellspacing="0" width="100%">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="th-sm">Vendor Name
                                    </th>
                                    <th class="th-sm">Product Name
                                    </th>
                                    <th class="th-sm">Quantity
                                    </th>
                                    <th class="th-sm">Estimated Price
                                    </th>
      ...
      response.sendRedirect("index.html");
                                        ...
                                        try{
                                            ...
                                            while(rs.next())
                                            {
                                              ...
                                              String ordate=rs.getString("vname");
                                              String reqdate=rs.getString("probydate");
                                             ...
                                             <tr>
                                                 <td>
                                                  ...
                                                  <td>
                                                      <button type="button"  class="btn btn-success"><a href="acceptedvendor.jsp?orderid=<%=rs.getString("orderid")%>"><i class="fa fa-check"></i></a></button>
                                                      <button type="button" class="btn btn-danger"><a href="rejectedvendor.jsp?orderid=<%=rs.getString("orderid")%>"><i class="fa fa-trash"></i></a></button>
                                                   </td>
                                             <style type="text/css">
                                                 .btn-success a
                                                 {
