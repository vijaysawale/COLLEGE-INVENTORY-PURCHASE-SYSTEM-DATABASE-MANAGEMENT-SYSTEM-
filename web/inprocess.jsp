...
<head>
    ...
    <title>In Process Purchase Orders</title>
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">In Process Purchase Order</span></h2>
                            </form>
                        </div>
                    </div> 
                                                 ...
                                                 <td>
                                                  ...
                                                  <td>
                                                      <%
                                                        if(sta==0)
                                                        {
                                                            out.print("Pending For Purchase Admin Aprroval");
                                                        }
                                                        if(sta==1)
                                                        {
                                                            out.print("Approved By Purchase Admin And Request Send To Vandors");
                                                        }
                                                       %>
                                                  </td>
                                            </tr>
