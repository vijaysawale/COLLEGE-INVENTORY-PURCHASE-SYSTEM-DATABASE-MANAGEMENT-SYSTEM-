    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="userfrontIT.jsp"><img src="assets/images/icon/logo.png" alt="logo"></a>
                </div>
            <style type="text/css">
                .logo
                {
                    ...
                    <script type="text/javascript">
                       $('.counter').counterUp({
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="productpurchaseit.jsp">New Order</a></li>
                                    <li><a href="previousorderit.jsp">Previous Orders</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="acceptit.jsp">Accepted</a></li>
                                    <li><a href="inprocessit.jsp">In Process</a></li>
                                    <li><a href="rejectit.jsp">Rejected</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">In process Orders</span></h2>
                            </form>
                        </div>
                    </div> 
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="userfrontIT.jsp">Home</a></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Information Technology<i class="fa fa-angle-down"></i></h4>
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        try{
                                            ...
                                            PreparedStatement pst = conn.prepareStatement("select * from userchooses where deptid='"+str+"' and status='"+0+"'");
