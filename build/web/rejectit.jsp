                       ...
                       $('.counter').counterUp({
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="rejectedit.jsp">Rejected</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">Rejected Orders</span></h2>
                            </form>
                        </div>
                    </div> 
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        try{
                                            ...
                                            PreparedStatement pst = conn.prepareStatement("select * from rejected where deptid='"+str+"'");
