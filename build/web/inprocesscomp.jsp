    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="userfrontCOMP.jsp"><img src="assets/images/icon/logo.png" alt="logo"></a>
                </div>
            <style type="text/css">
                .logo
                {
                       ...
                       $('.counter').counterUp({
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="previousordercomp.jsp">Previous Orders</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="acceptcomp.jsp">Accepted</a></li>
                                    <li><a href="inprocesscomp.jsp">In Process</a></li>
                                    <li><a href="rejectcomp.jsp">Rejected</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">In Process Order</span></h2>
                            </form>
                        </div>
                    </div> 
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="userfrontCOMP.jsp">Home</a></li>
